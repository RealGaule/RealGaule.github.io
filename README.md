...
The figure `notes-src/docs/assets/images/gibbs-convolution.svg` is generated by
`tools/render_gibbs_convolution.py` (needs NumPy and Matplotlib, e.g.
`/usr/bin/python3 tools/render_gibbs_convolution.py`).
